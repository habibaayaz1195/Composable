...
* @enum {string}
*/
export declare enum ErrorCodeId {
...
export declare class ErrorCodeIdConverter implements JsonCustomConvert<ErrorCodeId> {
    serialize(data: ErrorCodeId): ErrorCodeId;
