...
const OrderSummary = ({
    ...
    const [basketTax, setbasketTax] = useState(false);
   
    console.log(basketTax)
    useEffect(() => {
    const getTransaction = async () => {
        ...
        headers: {
            ...
            .then(data => {
                console.log(data);
                setdata(data)
                setbasketTax(data.totalTax)
                basket.Totaltax  = data.totalTax;
            //   basket.taxTotal = tt;
              basket.orderTotal = basket.Totaltax + basket.shippingTotal + basket.productTotal
            //   basket.orderTotal = pt;
            ...
            <Stack spacing={4} align="flex-start">
                ...
                <Stack w="full">
                    ...
                    <Flex justify="space-between">
                        ...
                        {basket != null && basket.shipments[0].shippingAddress !=null 
? (                
                            <Text fontSize={fontSize}>
                                <FormattedNumber
                                    
                                  value={basket.Totaltax}
                                    style="currency"
                                    currency={basket.currency}
                                />
                            </Text>
