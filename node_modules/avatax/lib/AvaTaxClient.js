...
exports.AvalaraError = void 0;
var node_fetch_1 = require("node-fetch");
var FormData = require("form-data");
var json2typescript_1 = require("json2typescript");
var basic_auth_1 = require("./utils/basic_auth");
var withTimeout_1 = require("./utils/withTimeout");
var Models = require("./models/index");
var logger_1 = require("./utils/logger");
var logObject_1 = require("./utils/logObject");
var fetch_result_1 = require("./utils/fetch_result");
var AvalaraError = /** @class */ (function (_super) {
    __extends(AvalaraError, _super);
    function AvalaraError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AvalaraError;
}(Error));
exports.AvalaraError = AvalaraError;
var AvaTaxClient = /** @class */ (function () {
    /**
     ...
     */
    function AvaTaxClient(_a) {
        var appName = _a.appName, appVersion = _a.appVersion, machineName = _a.machineName, environment = _a.environment, _b = _a.timeout, timeout = _b === void 0 ? 1200000 : _b, customHttpAgent = _a.customHttpAgent, _c = _a.logOptions, logOptions = _c === void 0 ? { logEnabled: false } : _c, _d = _a.enableStrictTypeConversion, enableStrictTypeConversion = _d === void 0 ? false : _d;
        this.apiVersion = '23.7.0';
        this.appNM = appName;
        ...
        this.logger = new logger_1.default(logOptions);
    }
    /**
     ...
     * @return {AvaTaxClient}
     */
    AvaTaxClient.prototype.withSecurity = function (_a) {
        var username = _a.username, password = _a.password, accountId = _a.accountId, licenseKey = _a.licenseKey, bearerToken = _a.bearerToken;
        if (username != null && password != null) {
            this.auth = (0, basic_auth_1.createBasicAuthHeader)(username, password);
        }
        else if (accountId != null && licenseKey != null) {
            this.auth = (0, basic_auth_1.createBasicAuthHeader)(accountId, licenseKey);
        }
     ...
     */
    AvaTaxClient.prototype.restCall = function (_a, toType) {
        var e_1, _b;
        var _this = this;
        var url = _a.url, verb = _a.verb, payload = _a.payload, _c = _a.clientId, clientId = _c === void 0 ? '' : _c, _d = _a.mapHeader, mapHeader = _d === void 0 ? new Map() : _d, _e = _a.isMultiPart, isMultiPart = _e === void 0 ? false : _e;
        var reqHeaders = {
        ...
        try {
            for (var mapHeader_1 = __values(mapHeader), mapHeader_1_1 = mapHeader_1.next(); !mapHeader_1_1.done; mapHeader_1_1 = mapHeader_1.next()) {
                var _f = __read(mapHeader_1_1.value, 2), key = _f[0], value = _f[1];
            ...
            try {
                if (mapHeader_1_1 && !mapHeader_1_1.done && (_b = mapHeader_1.return)) _b.call(mapHeader_1);
            }
        ...
        var logObject = new logObject_1.default(this.logger.logRequestAndResponseInfo);
        logObject.populateRequestInfo(url, options, payload);
        return (0, withTimeout_1.withTimeout)(this.timeout, (0, node_fetch_1.default)(url, options)).then(function (res) {
            ...
            if (contentType === 'application/vnd.ms-excel' || contentType === 'text/csv') {
                return res.text().then(function (txt) {
                    ...
                    res.text = function () { return Promise.resolve(txt); };
                    return res;
                    ...
                    _this.createLogEntry(logObject);
                });
            }
            ...
            return res.json().catch(function (error) {
                ...
                // handle error
                if (json && json.error) {
                    var ex = new AvalaraError(json.error.message);
                    ...
                    if (_this.enableStrictTypeConversion) {
                        if (typeof json === 'string') {
                            return json;
                        }
                        var jsonConvert = new json2typescript_1.JsonConvert(null, null, null, json2typescript_1.PropertyMatchingRule.CASE_INSENSITIVE);
     ...
     */
    AvaTaxClient.prototype.buildUrl = function (_a) {
    ...
    /**
       ...
       */
    AvaTaxClient.prototype.createLogEntry = function (logObject) {
     ...
     */
    AvaTaxClient.prototype.accountResetLicenseKey = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/resetlicensekey"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
            this.appVer +
     ...
     */
    AvaTaxClient.prototype.activateAccount = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/activate"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.auditAccount = function (_a) {
        var id = _a.id, start = _a.start, end = _a.end, top = _a.top, skip = _a.skip;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/audit"),
            parameters: {
                start: start,
                end: end,
                $top: top,
        ...
        var strClientId = this.appNM +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'get', payload: null, clientId: strClientId }, (fetch_result_1.FetchResult));
    };
    /**
     ...
     * @return {Models.LicenseKeyModel}
     */
    AvaTaxClient.prototype.createLicenseKey = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/licensekey"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.deleteLicenseKey = function (_a) {
        var id = _a.id, licensekeyname = _a.licensekeyname;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/licensekey/").concat(licensekeyname),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'delete', payload: null, clientId: strClientId }, (Array));
    };
    /**
     ...
     * @return {Models.AccountModel}
     */
    AvaTaxClient.prototype.getAccount = function (_a) {
        var id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id),
            parameters: {
                $include: include
            }
        });
     ...
     */
    AvaTaxClient.prototype.getAccountConfiguration = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/configuration"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'get', payload: null, clientId: strClientId }, (Array));
    };
    /**
     ...
     */
    AvaTaxClient.prototype.getLicenseKey = function (_a) {
        var id = _a.id, licensekeyname = _a.licensekeyname;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/licensekey/").concat(licensekeyname),
            parameters: {}
     ...
     * @return {Models.AccountLicenseKeyModel[]}
     */
    AvaTaxClient.prototype.getLicenseKeys = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/licensekeys"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.queryAccounts = function (_a) {
        var include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/accounts",
            parameters: {
                $include: include,
     ...
     * @return {Models.AccountConfigurationModel[]}
     */
    AvaTaxClient.prototype.setAccountConfiguration = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/configuration"),
            parameters: {}
        ...
        var strClientId = this.appNM +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'post', payload: model, clientId: strClientId }, (Array));
    };
    /**
     ...
     */
    AvaTaxClient.prototype.resolveAddress = function (_a) {
        var line1 = _a.line1, line2 = _a.line2, line3 = _a.line3, city = _a.city, region = _a.region, postalCode = _a.postalCode, country = _a.country, textCase = _a.textCase;
        var path = this.buildUrl({
     ...
     * @return {Models.AddressResolutionModel}
     */
    AvaTaxClient.prototype.resolveAddressPost = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/addresses/resolve",
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createCompanyLookupFile = function (_a) {
        var accountId = _a.accountId, companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/advancedrules/accounts/".concat(accountId, "/companies/").concat(companyId, "/lookupFiles"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteLookupFile = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/advancedrules/accounts/".concat(accountId, "/lookupFiles/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.getCompanyLookupFiles = function (_a) {
        var accountId = _a.accountId, companyId = _a.companyId;
        var path = this.buildUrl({
            url: "/api/v2/advancedrules/accounts/".concat(accountId, "/companies/").concat(companyId, "/lookupFiles"),
            parameters: {}
        });
     ...
     * @return {Models.AdvancedRuleLookupFileModel}
     */
    AvaTaxClient.prototype.getLookupFile = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/advancedrules/accounts/".concat(accountId, "/lookupFiles/").concat(id),
            parameters: {}
     ...
     * @return {Models.AdvancedRuleLookupFileModel}
     */
    AvaTaxClient.prototype.updateLookupFile = function (_a) {
        var accountId = _a.accountId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/advancedrules/accounts/".concat(accountId, "/lookupFiles/").concat(id),
            parameters: {}
        });
     ...
     */
    AvaTaxClient.prototype.createAvaFileForms = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteAvaFileForm = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/avafileforms/".concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.AvaFileFormModel}
     */
    AvaTaxClient.prototype.getAvaFileForm = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/avafileforms/".concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.queryAvaFileForms = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/avafileforms",
            parameters: {
                $filter: filter,
     ...
     * @return {Models.AvaFileFormModel}
     */
    AvaTaxClient.prototype.updateAvaFileForm = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/avafileforms/".concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.cancelBatch = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches/").concat(id, "/cancel"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.BatchModel[]}
     */
    AvaTaxClient.prototype.createBatches = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createTransactionBatch = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches/transactions"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteBatch = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.downloadBatch = function (_a) {
        var companyId = _a.companyId, batchId = _a.batchId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches/").concat(batchId, "/files/").concat(id, "/attachment"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.BatchModel}
     */
    AvaTaxClient.prototype.getBatch = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listBatchesByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/batches"),
            parameters: {
                $filter: filter,
     ...
     * @return {FetchResult<Models.BatchModel>}
     */
    AvaTaxClient.prototype.queryBatches = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/batches",
            parameters: {
                $filter: filter,
     ...
     */
    AvaTaxClient.prototype.createCertExpressInvitation = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certexpressinvites"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.getCertExpressInvitation = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certexpressinvites/").concat(id),
            parameters: {
                $include: include
            }
        });
     ...
     */
    AvaTaxClient.prototype.listCertExpressInvitations = function (_a) {
        var companyId = _a.companyId, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certexpressinvites"),
            parameters: {
                $include: include,
                $filter: filter,
                $top: top,
     ...
     */
    AvaTaxClient.prototype.createCertificates = function (_a) {
        var companyId = _a.companyId, preValidatedExemptionReason = _a.preValidatedExemptionReason, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates"),
            parameters: {
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.downloadCertificateImage = function (_a) {
        var companyId = _a.companyId, id = _a.id, page = _a.page, type = _a.type;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/attachment"),
            parameters: {
                $page: page,
                $type: type
            }
     ...
     * @return {Models.CertificateModel}
     */
    AvaTaxClient.prototype.getCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id),
            parameters: {
                $include: include
     ...
     */
    AvaTaxClient.prototype.getCertificateSetup = function (_a) {
        var companyId = _a.companyId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/setup"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.linkAttributesToCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/attributes/link"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'post', payload: model, clientId: strClientId }, (fetch_result_1.FetchResult));
    };
    /**
     ...
     */
    AvaTaxClient.prototype.linkCustomersToCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/customers/link"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CertificateAttributeModel>}
     */
    AvaTaxClient.prototype.listAttributesForCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/attributes"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CustomerModel>}
     */
    AvaTaxClient.prototype.listCustomersForCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/customers"),
            parameters: {
                $include: include
            }
        });
     ...
     */
    AvaTaxClient.prototype.queryCertificates = function (_a) {
        var companyId = _a.companyId, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates"),
            parameters: {
     ...
     * @return {Models.ProvisionStatusModel}
     */
    AvaTaxClient.prototype.requestCertificateSetup = function (_a) {
        var companyId = _a.companyId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/setup"),
            parameters: {}
     ...
     * @return {FetchResult<Models.CertificateAttributeModel>}
     */
    AvaTaxClient.prototype.unlinkAttributesFromCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/attributes/unlink"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CustomerModel>}
     */
    AvaTaxClient.prototype.unlinkCustomersFromCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/customers/unlink"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CertificateModel}
     */
    AvaTaxClient.prototype.updateCertificate = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id),
            parameters: {}
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.uploadCertificateImage = function (_a) {
        var companyId = _a.companyId, id = _a.id, file = _a.file;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/certificates/").concat(id, "/attachment"),
            parameters: {}
        });
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.certifyIntegration = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/certify"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.changeFilingStatus = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/filingstatus"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.companyInitialize = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.CompanyModel[]}
     */
    AvaTaxClient.prototype.createCompanies = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createCompanyParameters = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/parameters"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createFundingRequest = function (_a) {
        var id = _a.id, businessUnit = _a.businessUnit, subscriptionType = _a.subscriptionType, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/funding/setup"),
            parameters: {
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteCompany = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteCompanyParameter = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/parameters/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.fundingConfigurationByCompany = function (_a) {
        var companyId = _a.companyId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/funding/configuration"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.FundingConfigurationModel[]}
     */
    AvaTaxClient.prototype.fundingConfigurationsByCompanyAndCurrency = function (_a) {
        var companyId = _a.companyId, currency = _a.currency;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/funding/configurations"),
            parameters: {
                currency: currency
            }
        });
     ...
     * @return {Models.CompanyModel}
     */
    AvaTaxClient.prototype.getCompany = function (_a) {
        var id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id),
            parameters: {
     ...
     */
    AvaTaxClient.prototype.getCompanyConfiguration = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/configuration"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CompanyParameterDetailModel}
     */
    AvaTaxClient.prototype.getCompanyParameterDetail = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/parameters/").concat(id),
            parameters: {}
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.getFilingStatus = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/filingstatus"),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listACHEntryDetailsForCompany = function (_a) {
        var id = _a.id, periodyear = _a.periodyear, periodmonth = _a.periodmonth;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/paymentdetails/").concat(periodyear, "/").concat(periodmonth),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listCompanyParameterDetails = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/parameters"),
            parameters: {
                $filter: filter,
     ...
     * @return {Models.FundingStatusModel[]}
     */
    AvaTaxClient.prototype.listFundingRequestsByCompany = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/funding"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listMrsCompanies = function () {
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.queryCompanies = function (_a) {
        var include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies",
            parameters: {
     ...
     * @return {Models.CompanyConfigurationModel[]}
     */
    AvaTaxClient.prototype.setCompanyConfiguration = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id, "/configuration"),
            parameters: {}
     ...
     * @return {Models.CompanyModel}
     */
    AvaTaxClient.prototype.updateCompany = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(id),
            parameters: {}
     ...
     * @return {Models.CompanyParameterDetailModel}
     */
    AvaTaxClient.prototype.updateCompanyParameterDetail = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/parameters/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createContacts = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/contacts"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteContact = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/contacts/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ContactModel}
     */
    AvaTaxClient.prototype.getContact = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/contacts/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listContactsByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/contacts"),
            parameters: {
     ...
     * @return {FetchResult<Models.ContactModel>}
     */
    AvaTaxClient.prototype.queryContacts = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/contacts",
            parameters: {
     ...
     * @return {Models.ContactModel}
     */
    AvaTaxClient.prototype.updateContact = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/contacts/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createCustomers = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CustomerModel}
     */
    AvaTaxClient.prototype.deleteCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CustomerModel}
     */
    AvaTaxClient.prototype.getCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode),
            parameters: {
                $include: include
     ...
     */
    AvaTaxClient.prototype.linkAttributesToCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/attributes/link"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'put', payload: model, clientId: strClientId }, (fetch_result_1.FetchResult));
    };
    /**
     ...
     * @return {FetchResult<Models.CertificateModel>}
     */
    AvaTaxClient.prototype.linkCertificatesToCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certificates/link"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CustomerModel}
     */
    AvaTaxClient.prototype.linkShipToCustomersToBillCustomer = function (_a) {
        var companyId = _a.companyId, code = _a.code, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/billto/").concat(code, "/shipto/link"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CustomerAttributeModel>}
     */
    AvaTaxClient.prototype.listAttributesForCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/attributes"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CertificateModel>}
     */
    AvaTaxClient.prototype.listCertificatesForCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certificates"),
            parameters: {
                $include: include,
                $filter: filter,
                $top: top,
     ...
     */
    AvaTaxClient.prototype.listValidCertificatesForCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, country = _a.country, region = _a.region;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certificates/").concat(country, "/").concat(region),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CustomerModel>}
     */
    AvaTaxClient.prototype.queryCustomers = function (_a) {
        var companyId = _a.companyId, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers"),
            parameters: {
     ...
     * @return {FetchResult<Models.CustomerAttributeModel>}
     */
    AvaTaxClient.prototype.unlinkAttributesFromCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/attributes/unlink"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.CertificateModel>}
     */
    AvaTaxClient.prototype.unlinkCertificatesFromCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode, "/certificates/unlink"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CustomerModel}
     */
    AvaTaxClient.prototype.updateCustomer = function (_a) {
        var companyId = _a.companyId, customerCode = _a.customerCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/customers/").concat(customerCode),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createDataSources = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/datasources"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteDataSource = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/datasources/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.DataSourceModel}
     */
    AvaTaxClient.prototype.getDataSourceById = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/datasources/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listDataSources = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/datasources"),
            parameters: {
     ...
     * @return {FetchResult<Models.DataSourceModel>}
     */
    AvaTaxClient.prototype.queryDataSources = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {Models.DataSourceModel}
     */
    AvaTaxClient.prototype.updateDataSource = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/datasources/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.getCrossBorderCode = function (_a) {
        var country = _a.country, hsCode = _a.hsCode;
        var path = this.buildUrl({
            url: "/api/v2/definitions/crossborder/".concat(country, "/").concat(hsCode, "/hierarchy"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.getLoginVerifierByForm = function (_a) {
        var form = _a.form, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/filingcalendars/loginverifiers/".concat(form),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listAllMarketplaceLocations = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.AvaFileFormModel>}
     */
    AvaTaxClient.prototype.listAvaFileForms = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.CertificateAttributeModel>}
     */
    AvaTaxClient.prototype.listCertificateAttributes = function (_a) {
        var companyid = _a.companyid, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCertificateExemptReasons = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCertificateExposureZones = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listClassificationParametersUsage = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCommunicationsServiceTypes = function (_a) {
        var id = _a.id, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/communications/transactiontypes/".concat(id, "/servicetypes"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listCommunicationsTransactionTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.CommunicationsTSPairModel>}
     */
    AvaTaxClient.prototype.listCommunicationsTSPairs = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCountries = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCoverLetters = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.HsCodeModel>}
     */
    AvaTaxClient.prototype.listCrossBorderCodes = function (_a) {
        var country = _a.country, hsCode = _a.hsCode, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/crossborder/".concat(country, "/").concat(hsCode),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     * @return {FetchResult<Models.HsCodeModel>}
     */
    AvaTaxClient.prototype.listCrossBorderSections = function () {
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listCurrencies = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listEntityUseCodes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listFilingFrequencies = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listJurisdictions = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listJurisdictionsByAddress = function (_a) {
        var line1 = _a.line1, line2 = _a.line2, line3 = _a.line3, city = _a.city, region = _a.region, postalCode = _a.postalCode, country = _a.country, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listJurisdictionsByRateTypeTaxTypeMapping = function (_a) {
        var country = _a.country, taxTypeId = _a.taxTypeId, taxSubTypeId = _a.taxSubTypeId, rateTypeId = _a.rateTypeId, region = _a.region, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/jurisdictions/countries/".concat(country, "/taxtypes/").concat(taxTypeId, "/taxsubtypes/").concat(taxSubTypeId),
            parameters: {
     ...
     * @return {string[]}
     */
    AvaTaxClient.prototype.listJurisdictionTypesByRateTypeTaxTypeMapping = function (_a) {
        var country = _a.country, taxTypeId = _a.taxTypeId, taxSubTypeId = _a.taxSubTypeId, rateTypeId = _a.rateTypeId;
        var path = this.buildUrl({
            url: "/api/v2/definitions/jurisdictionTypes/countries/".concat(country, "/taxtypes/").concat(taxTypeId, "/taxsubtypes/").concat(taxSubTypeId),
            parameters: {
                rateTypeId: rateTypeId
            }
        });
     ...
     */
    AvaTaxClient.prototype.listLocationQuestionsByAddress = function (_a) {
        var line1 = _a.line1, line2 = _a.line2, line3 = _a.line3, city = _a.city, region = _a.region, postalCode = _a.postalCode, country = _a.country, latitude = _a.latitude, longitude = _a.longitude, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.SkyscraperStatusModel>}
     */
    AvaTaxClient.prototype.listLoginVerifiers = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listMarketplaceLocations = function (_a) {
        var marketplaceId = _a.marketplaceId, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNexus = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByAddress = function (_a) {
        var line1 = _a.line1, line2 = _a.line2, line3 = _a.line3, city = _a.city, region = _a.region, postalCode = _a.postalCode, country = _a.country, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByCountry = function (_a) {
        var country = _a.country, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/nexus/".concat(country),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByCountryAndRegion = function (_a) {
        var country = _a.country, region = _a.region, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/nexus/".concat(country, "/").concat(region),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listNexusByFormCode = function (_a) {
        var formCode = _a.formCode;
        var path = this.buildUrl({
            url: "/api/v2/definitions/nexus/byform/".concat(formCode),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByTaxTypeGroup = function (_a) {
        var taxTypeGroup = _a.taxTypeGroup, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/nexus/bytaxtypegroup/".concat(taxTypeGroup),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listNexusTaxTypeGroups = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeCustomerFundingOptions = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeCustomerTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeFilingtypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticePriorities = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeReasons = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeResponsibilities = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeRootCauses = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeStatuses = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listNoticeTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listParameters = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.ParameterModel>}
     */
    AvaTaxClient.prototype.listParametersByAccount = function (_a) {
        var accountId = _a.accountId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/accounts/".concat(accountId, "/parameters"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     * @return {FetchResult<Models.ParameterModel>}
     */
    AvaTaxClient.prototype.listParametersByItem = function (_a) {
        var companyCode = _a.companyCode, itemCode = _a.itemCode, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/parameters/byitem/".concat(companyCode, "/").concat(itemCode),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listParametersUsage = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listPermissions = function (_a) {
        var top = _a.top, skip = _a.skip;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listPostalCodes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy, includeExpiredPostalCodes = _a.includeExpiredPostalCodes;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listPreferredPrograms = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listProductClassificationSystems = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy, countryCode = _a.countryCode;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.ProductClassificationSystemModel>}
     */
    AvaTaxClient.prototype.listProductClassificationSystemsByCompany = function (_a) {
        var companyCode = _a.companyCode, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy, countryCode = _a.countryCode;
        var path = this.buildUrl({
            url: "/api/v2/definitions/productclassificationsystems/bycompany/".concat(companyCode),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listRateTypesByCountry = function (_a) {
        var country = _a.country, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/countries/".concat(country, "/ratetypes"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listRateTypesByCountryTaxTypeTaxSubType = function (_a) {
        var country = _a.country, taxTypeId = _a.taxTypeId, taxSubTypeId = _a.taxSubTypeId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/countries/".concat(country, "/taxtypes/").concat(taxTypeId, "/taxsubtypes/").concat(taxSubTypeId, "/ratetypes"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listRegions = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.IsoRegionModel>}
     */
    AvaTaxClient.prototype.listRegionsByCountry = function (_a) {
        var country = _a.country, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/countries/".concat(country, "/regions"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     * @return {FetchResult<Models.IsoRegionModel>}
     */
    AvaTaxClient.prototype.listRegionsByCountryAndTaxTypeAndTaxSubTypeAndRateType = function (_a) {
        var companyId = _a.companyId, country = _a.country, taxTypeId = _a.taxTypeId, taxSubTypeId = _a.taxSubTypeId, rateTypeId = _a.rateTypeId, jurisdictionTypeId = _a.jurisdictionTypeId, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/companies/".concat(companyId, "/countries/").concat(country, "/regions/taxtypes/").concat(taxTypeId, "/taxsubtypes/").concat(taxSubTypeId, "/rateTypeId/").concat(rateTypeId, "/jurisdictionTypeId/").concat(jurisdictionTypeId),
            parameters: {
                $top: top,
                $skip: skip,
                $orderBy: orderBy
     ...
     */
    AvaTaxClient.prototype.listResourceFileTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listReturnsParametersUsage = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listSecurityRoles = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listSubscriptionTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTags = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxAuthorities = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxAuthorityForms = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxAuthorityTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxCodes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxCodeTypes = function (_a) {
        var top = _a.top, skip = _a.skip;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxForms = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxSubTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {FetchResult<Models.TaxSubTypeModel>}
     */
    AvaTaxClient.prototype.listTaxSubTypesByCountryAndTaxType = function (_a) {
        var country = _a.country, taxTypeId = _a.taxTypeId, companyId = _a.companyId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/taxsubtypes/countries/".concat(country, "/taxtypes/").concat(taxTypeId),
            parameters: {
                companyId: companyId,
                $filter: filter,
                $top: top,
     ...
     * @return {FetchResult<Models.TaxSubTypeModel>}
     */
    AvaTaxClient.prototype.listTaxSubTypesByJurisdictionAndRegion = function (_a) {
        var jurisdictionCode = _a.jurisdictionCode, region = _a.region, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/taxsubtypes/".concat(jurisdictionCode, "/").concat(region),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listTaxTypeGroups = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.listTaxTypesByNexusAndCountry = function (_a) {
        var country = _a.country, companyId = _a.companyId, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/taxtypes/countries/".concat(country),
            parameters: {
                companyId: companyId,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listUnitOfBasisByCountryAndTaxTypeAndTaxSubTypeAndRateType = function (_a) {
        var country = _a.country, taxTypeId = _a.taxTypeId, taxSubTypeId = _a.taxSubTypeId, rateTypeId = _a.rateTypeId, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/definitions/unitofbasis/countries/".concat(country, "/taxtypes/").concat(taxTypeId, "/taxsubtypes/").concat(taxSubTypeId),
            parameters: {
                rateTypeId: rateTypeId,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listUnitOfMeasurement = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createDistanceThreshold = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/distancethresholds"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteDistanceThreshold = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/distancethresholds/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.CompanyDistanceThresholdModel}
     */
    AvaTaxClient.prototype.getDistanceThreshold = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/distancethresholds/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listDistanceThresholds = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/distancethresholds"),
            parameters: {
     ...
     * @return {FetchResult<Models.CompanyDistanceThresholdModel>}
     */
    AvaTaxClient.prototype.queryDistanceThresholds = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {Models.CompanyDistanceThresholdModel}
     */
    AvaTaxClient.prototype.updateDistanceThreshold = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/distancethresholds/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createECommerceToken = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/ecommercetokens"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.refreshECommerceToken = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/ecommercetokens"),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.approveFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id, "/approve"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.createAndLinkNewFirmClientAccount = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.createFirmClientLinkage = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.getFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listFirmClientLinkage = function (_a) {
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.rejectFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id, "/reject"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.resetFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id, "/reset"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.FirmClientLinkageOutputModel}
     */
    AvaTaxClient.prototype.revokeFirmClientLinkage = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/firmclientlinkages/".concat(id, "/revoke"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.requestFreeTrial = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.FundingStatusModel}
     */
    AvaTaxClient.prototype.activateFundingRequest = function (_a) {
        var id = _a.id, businessUnit = _a.businessUnit, subscriptionType = _a.subscriptionType;
        var path = this.buildUrl({
            url: "/api/v2/fundingrequests/".concat(id, "/widget"),
            parameters: {
                businessUnit: businessUnit,
                subscriptionType: subscriptionType
            }
     ...
     * @return {Models.FundingStatusModel}
     */
    AvaTaxClient.prototype.fundingRequestStatus = function (_a) {
        var id = _a.id, businessUnit = _a.businessUnit, subscriptionType = _a.subscriptionType;
        var path = this.buildUrl({
            url: "/api/v2/fundingrequests/".concat(id),
            parameters: {
                businessUnit: businessUnit,
                subscriptionType: subscriptionType
            }
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.batchDeleteItemClassifications = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.batchDeleteItemParameters = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.bulkUploadItems = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/upload"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createItemClassifications = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications"),
            parameters: {}
        });
     ...
     */
    AvaTaxClient.prototype.createItemParameters = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters"),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createItems = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createItemTags = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/tags"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createTaxCodeClassificationRequest = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/classificationrequests/taxcode"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteCatalogueItem = function (_a) {
        var companyId = _a.companyId, itemCode = _a.itemCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/itemcatalogue/").concat(itemCode),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteItem = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteItemClassification = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteItemParameter = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteItemTag = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, itemTagDetailId = _a.itemTagDetailId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/tags/").concat(itemTagDetailId),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteItemTags = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/tags"),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.getClassificationStatus = function (_a) {
        var companyId = _a.companyId, includeClassificationDetails = _a.includeClassificationDetails, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/classificationrequests/taxcode"),
            parameters: {
     ...
     * @return {Models.ItemModel}
     */
    AvaTaxClient.prototype.getItem = function (_a) {
        var companyId = _a.companyId, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(id),
            parameters: {
     ...
     * @return {Models.ItemClassificationOutputModel}
     */
    AvaTaxClient.prototype.getItemClassification = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications/").concat(id),
            parameters: {}
     ...
     * @return {Models.ItemParameterModel}
     */
    AvaTaxClient.prototype.getItemParameter = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.getItemTags = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, filter = _a.filter, top = _a.top, skip = _a.skip;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/tags"),
            parameters: {
                $filter: filter,
     ...
     */
    AvaTaxClient.prototype.getPremiumClassification = function (_a) {
        var companyId = _a.companyId, itemCode = _a.itemCode, systemCode = _a.systemCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemCode, "/premiumClassification/").concat(systemCode),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.getTaxCodeRecommendations = function (_a) {
        var companyId = _a.companyId, requestId = _a.requestId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/classificationrequests/taxcode/").concat(requestId, "/recommendations"),
            parameters: {
                $filter: filter,
                $top: top,
                $skip: skip,
     ...
     */
    AvaTaxClient.prototype.listImportRestrictions = function (_a) {
        var companyId = _a.companyId, itemCode = _a.itemCode, countryOfImport = _a.countryOfImport, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemCode, "/restrictions/import/").concat(countryOfImport),
            parameters: {
                $top: top,
                $skip: skip,
                $orderBy: orderBy
     ...
     */
    AvaTaxClient.prototype.listItemClassifications = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications"),
            parameters: {
                $filter: filter,
     ...
     */
    AvaTaxClient.prototype.listItemParameters = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters"),
            parameters: {
     ...
     */
    AvaTaxClient.prototype.listItemsByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy, tagName = _a.tagName;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items"),
            parameters: {
                $filter: filter,
     ...
     * @return {FetchResult<Models.ItemModel>}
     */
    AvaTaxClient.prototype.queryItems = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/items",
            parameters: {
     ...
     * @return {FetchResult<Models.ItemModel>}
     */
    AvaTaxClient.prototype.queryItemsByTag = function (_a) {
        var companyId = _a.companyId, tag = _a.tag, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/bytags/").concat(tag),
            parameters: {
                $filter: filter,
                $include: include,
                $top: top,
     ...
     */
    AvaTaxClient.prototype.syncItemCatalogue = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/itemcatalogue"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.syncItems = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/sync"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ItemModel}
     */
    AvaTaxClient.prototype.updateItem = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(id),
            parameters: {}
     ...
     * @return {Models.ItemClassificationOutputModel}
     */
    AvaTaxClient.prototype.updateItemClassification = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/classifications/").concat(id),
            parameters: {}
        });
     ...
     * @return {Models.ItemParameterModel}
     */
    AvaTaxClient.prototype.updateItemParameter = function (_a) {
        var companyId = _a.companyId, itemId = _a.itemId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/items/").concat(itemId, "/parameters/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createJurisdictionOverrides = function (_a) {
        var accountId = _a.accountId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/jurisdictionoverrides"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteJurisdictionOverride = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/jurisdictionoverrides/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.JurisdictionOverrideModel}
     */
    AvaTaxClient.prototype.getJurisdictionOverride = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/jurisdictionoverrides/").concat(id),
            parameters: {}
     ...
     * @return {FetchResult<Models.JurisdictionOverrideModel>}
     */
    AvaTaxClient.prototype.listJurisdictionOverridesByAccount = function (_a) {
        var accountId = _a.accountId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/jurisdictionoverrides"),
            parameters: {
                $filter: filter,
     ...
     * @return {FetchResult<Models.JurisdictionOverrideModel>}
     */
    AvaTaxClient.prototype.queryJurisdictionOverrides = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {Models.JurisdictionOverrideModel}
     */
    AvaTaxClient.prototype.updateJurisdictionOverride = function (_a) {
        var accountId = _a.accountId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/jurisdictionoverrides/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createLocationParameters = function (_a) {
        var companyId = _a.companyId, locationId = _a.locationId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(locationId, "/parameters"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createLocations = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteLocation = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteLocationParameter = function (_a) {
        var companyId = _a.companyId, locationId = _a.locationId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(locationId, "/parameters/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.LocationModel}
     */
    AvaTaxClient.prototype.getLocation = function (_a) {
        var companyId = _a.companyId, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(id),
            parameters: {
     ...
     * @return {Models.LocationParameterModel}
     */
    AvaTaxClient.prototype.getLocationParameter = function (_a) {
        var companyId = _a.companyId, locationId = _a.locationId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(locationId, "/parameters/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listLocationParameters = function (_a) {
        var companyId = _a.companyId, locationId = _a.locationId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(locationId, "/parameters"),
            parameters: {
                $filter: filter,
     ...
     */
    AvaTaxClient.prototype.listLocationsByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations"),
            parameters: {
     ...
     * @return {FetchResult<Models.LocationModel>}
     */
    AvaTaxClient.prototype.queryLocations = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {Models.LocationModel}
     */
    AvaTaxClient.prototype.updateLocation = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(id),
            parameters: {}
     ...
     * @return {Models.LocationParameterModel}
     */
    AvaTaxClient.prototype.updateLocationParameter = function (_a) {
        var companyId = _a.companyId, locationId = _a.locationId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(locationId, "/parameters/").concat(id),
            parameters: {}
        });
     ...
     */
    AvaTaxClient.prototype.validateLocation = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(id, "/validate"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.adjustMultiDocumentTransaction = function (_a) {
        var code = _a.code, type = _a.type, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(code, "/type/").concat(type, "/adjust"),
            parameters: {
                include: include
            }
        });
     ...
     */
    AvaTaxClient.prototype.auditMultiDocumentTransaction = function (_a) {
        var code = _a.code, type = _a.type;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(code, "/type/").concat(type, "/audit"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.commitMultiDocumentTransaction = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.createMultiDocumentTransaction = function (_a) {
        var include = _a.include, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.getMultiDocumentTransactionByCodeAndType = function (_a) {
        var code = _a.code, type = _a.type, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(code, "/type/").concat(type),
            parameters: {
                $include: include
            }
        });
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.getMultiDocumentTransactionById = function (_a) {
        var id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(id),
            parameters: {
                $include: include
            }
        });
     ...
     */
    AvaTaxClient.prototype.listMultiDocumentTransactions = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument",
            parameters: {
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.refundMultiDocumentTransaction = function (_a) {
        var code = _a.code, type = _a.type, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(code, "/type/").concat(type, "/refund"),
            parameters: {
                $include: include
            }
        });
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.verifyMultiDocumentTransaction = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.MultiDocumentModel}
     */
    AvaTaxClient.prototype.voidMultiDocumentTransaction = function (_a) {
        var code = _a.code, type = _a.type, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/transactions/multidocument/".concat(code, "/type/").concat(type, "/void"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createNexus = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.createNexusParameters = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.declareNexusByAddress = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/byaddress"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNexus = function (_a) {
        var companyId = _a.companyId, id = _a.id, cascadeDelete = _a.cascadeDelete;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(id),
            parameters: {
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNexusParameter = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNexusParameters = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters"),
            parameters: {}
        });
     ...
     * @return {Models.NexusModel}
     */
    AvaTaxClient.prototype.getNexus = function (_a) {
        var companyId = _a.companyId, id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(id),
            parameters: {
     ...
     * @return {Models.NexusByTaxFormModel}
     */
    AvaTaxClient.prototype.getNexusByFormCode = function (_a) {
        var companyId = _a.companyId, formCode = _a.formCode, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/byform/").concat(formCode),
            parameters: {
                $include: include
            }
        });
     ...
     * @return {Models.NexusParameterDetailModel}
     */
    AvaTaxClient.prototype.getNexusParameter = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters/").concat(id),
            parameters: {}
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus"),
            parameters: {
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.listNexusByCompanyAndTaxTypeGroup = function (_a) {
        var companyId = _a.companyId, taxTypeGroup = _a.taxTypeGroup, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/byTaxTypeGroup/").concat(taxTypeGroup),
            parameters: {
                $filter: filter,
                $include: include,
                $top: top,
     ...
     */
    AvaTaxClient.prototype.listNexusParameters = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters"),
            parameters: {
                $filter: filter,
     ...
     * @return {FetchResult<Models.NexusModel>}
     */
    AvaTaxClient.prototype.queryNexus = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/nexus",
            parameters: {
     ...
     * @return {Models.NexusModel}
     */
    AvaTaxClient.prototype.updateNexus = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(id),
            parameters: {}
     ...
     * @return {Models.NexusParameterDetailModel}
     */
    AvaTaxClient.prototype.updateNexusParameter = function (_a) {
        var companyId = _a.companyId, nexusId = _a.nexusId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/nexus/").concat(nexusId, "/parameters/").concat(id),
            parameters: {}
        });
     ...
     */
    AvaTaxClient.prototype.createNoticeResponsibilityType = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createNoticeRootCauseType = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNoticeResponsibilityType = function (_a) {
        var responsibilityId = _a.responsibilityId;
        var path = this.buildUrl({
            url: "/api/v2/notices/responsibilities/".concat(responsibilityId),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNoticeRootCauseType = function (_a) {
        var rootCauseId = _a.rootCauseId;
        var path = this.buildUrl({
            url: "/api/v2/notices/rootcauses/".concat(rootCauseId),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.dismissNotification = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/notifications/".concat(id, "/dismiss"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.NotificationModel}
     */
    AvaTaxClient.prototype.getNotification = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/notifications/".concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listNotifications = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {Models.NewAccountModel}
     */
    AvaTaxClient.prototype.requestNewAccount = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.requestNewEntitlement = function (_a) {
        var id = _a.id, offer = _a.offer;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id, "/entitlements/").concat(offer),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.AccountModel[]}
     */
    AvaTaxClient.prototype.createAccount = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts",
            parameters: {}
     ...
     * @return {Models.NotificationModel[]}
     */
    AvaTaxClient.prototype.createNotifications = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/notifications",
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.createSubscriptions = function (_a) {
        var accountId = _a.accountId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/subscriptions"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteAccount = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id),
            parameters: {}
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteNotification = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/notifications/".concat(id),
            parameters: {}
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteSubscription = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/subscriptions/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.SubscriptionTypeModel>}
     */
    AvaTaxClient.prototype.listServiceTypes = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.resetPassword = function (_a) {
        var userId = _a.userId, isUndoMigrateRequest = _a.isUndoMigrateRequest, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/passwords/".concat(userId, "/reset"),
            parameters: {
     ...
     * @return {Models.AccountModel}
     */
    AvaTaxClient.prototype.updateAccount = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(id),
            parameters: {}
     ...
     * @return {Models.NotificationModel}
     */
    AvaTaxClient.prototype.updateNotification = function (_a) {
        var id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/notifications/".concat(id),
            parameters: {}
     ...
     * @return {Models.SubscriptionModel}
     */
    AvaTaxClient.prototype.updateSubscription = function (_a) {
        var accountId = _a.accountId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/subscriptions/").concat(id),
            parameters: {}
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.downloadReport = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/reports/".concat(id, "/attachment"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.getReport = function (_a) {
        var id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/reports/".concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ReportModel[]}
     */
    AvaTaxClient.prototype.initiateExportDocumentLineReport = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/reports/exportdocumentline/initiate"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listReports = function (_a) {
        var companyId = _a.companyId, pageKey = _a.pageKey, skip = _a.skip, top = _a.top;
        var path = this.buildUrl({
            url: "/api/v2/reports",
            parameters: {
                companyId: companyId,
     ...
     */
    AvaTaxClient.prototype.createSettings = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/settings"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteSetting = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/settings/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.SettingModel}
     */
    AvaTaxClient.prototype.getSetting = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/settings/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listSettingsByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/settings"),
            parameters: {
     ...
     * @return {FetchResult<Models.SettingModel>}
     */
    AvaTaxClient.prototype.querySettings = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/settings",
            parameters: {
     ...
     * @return {Models.SettingModel}
     */
    AvaTaxClient.prototype.updateSetting = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/settings/").concat(id),
            parameters: {}
     ...
     * @return {Models.SubscriptionModel}
     */
    AvaTaxClient.prototype.getSubscription = function (_a) {
        var accountId = _a.accountId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/subscriptions/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listSubscriptionsByAccount = function (_a) {
        var accountId = _a.accountId, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/subscriptions"),
            parameters: {
     ...
     * @return {FetchResult<Models.SubscriptionModel>}
     */
    AvaTaxClient.prototype.querySubscriptions = function (_a) {
        var filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createTaxCodes = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxcodes"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteTaxCode = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxcodes/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.TaxCodeModel}
     */
    AvaTaxClient.prototype.getTaxCode = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxcodes/").concat(id),
            parameters: {}
     ...
     * @return {FetchResult<Models.TaxCodeModel>}
     */
    AvaTaxClient.prototype.listTaxCodesByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxcodes"),
            parameters: {
     ...
     * @return {FetchResult<Models.TaxCodeModel>}
     */
    AvaTaxClient.prototype.queryTaxCodes = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/taxcodes",
            parameters: {
     ...
     * @return {Models.TaxCodeModel}
     */
    AvaTaxClient.prototype.updateTaxCode = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxcodes/").concat(id),
            parameters: {}
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.buildTaxContentFile = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.buildTaxContentFileForLocation = function (_a) {
        var companyId = _a.companyId, id = _a.id, date = _a.date, format = _a.format, partnerId = _a.partnerId, includeJurisCodes = _a.includeJurisCodes;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/locations/").concat(id, "/pointofsaledata"),
            parameters: {
                date: date,
                format: format,
                partnerId: partnerId,
     ...
     * @return {object}
     */
    AvaTaxClient.prototype.downloadTaxRatesByZipCode = function (_a) {
        var date = _a.date, region = _a.region;
        var path = this.buildUrl({
            url: "/api/v2/taxratesbyzipcode/download/".concat(date),
            parameters: {
                region: region
            }
        });
     ...
     */
    AvaTaxClient.prototype.taxRatesByAddress = function (_a) {
        var line1 = _a.line1, line2 = _a.line2, line3 = _a.line3, city = _a.city, region = _a.region, postalCode = _a.postalCode, country = _a.country;
        var path = this.buildUrl({
     ...
     * @return {Models.TaxRateModel}
     */
    AvaTaxClient.prototype.taxRatesByPostalCode = function (_a) {
        var country = _a.country, postalCode = _a.postalCode;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createCountryCoefficients = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
        ...
        var strClientId = this.appNM +
            ...
            '; JavascriptSdk; ' + this.apiVersion + '; ' +
            this.machineNM;
        return this.restCall({ url: path, verb: 'put', payload: model, clientId: strClientId }, (Array));
    };
    /**
     ...
     */
    AvaTaxClient.prototype.createTaxRules = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxrules"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteTaxRule = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxrules/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.TaxRuleModel}
     */
    AvaTaxClient.prototype.getTaxRule = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxrules/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listCountryCoefficients = function (_a) {
        var country = _a.country, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/".concat(country, "/CountryCoefficients"),
            parameters: {
                $filter: filter,
                $include: include,
                $top: top,
     ...
     */
    AvaTaxClient.prototype.listTaxRules = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxrules"),
            parameters: {
     ...
     * @return {FetchResult<Models.TaxRuleModel>}
     */
    AvaTaxClient.prototype.queryTaxRules = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/taxrules",
            parameters: {
     ...
     * @return {Models.TaxRuleModel}
     */
    AvaTaxClient.prototype.updateTaxRule = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/taxrules/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.addLines = function (_a) {
        var include = _a.include, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.adjustTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/adjust"),
            parameters: {
     ...
     */
    AvaTaxClient.prototype.auditTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/audit"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.AuditTransactionModel}
     */
    AvaTaxClient.prototype.auditTransactionWithType = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/types/").concat(documentType, "/audit"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.bulkLockTransaction = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.changeTransactionCode = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/changecode"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.commitTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/commit"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.createOrAdjustTransaction = function (_a) {
        var include = _a.include, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.createTransaction = function (_a) {
        var include = _a.include, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.deleteLines = function (_a) {
        var include = _a.include, model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.getAllVarianceReportByCompanyCode = function (_a) {
        var companyCode = _a.companyCode;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/AllVariance"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.getTransactionByCode = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.getTransactionByCodeAndType = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/types/").concat(documentType),
            parameters: {
                $include: include
            }
        });
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.getTransactionById = function (_a) {
        var id = _a.id, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/transactions/".concat(id),
            parameters: {
                $include: include
            }
        });
     ...
     * @return {Models.VarianceResponseModel}
     */
    AvaTaxClient.prototype.getVarianceReportByCompanyCodeByTransactionId = function (_a) {
        var companyCode = _a.companyCode, transactionId = _a.transactionId;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionId, "/variance"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listTransactionsByCompany = function (_a) {
        var companyCode = _a.companyCode, dataSourceId = _a.dataSourceId, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions"),
            parameters: {
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.lockTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/lock"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.refundTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, include = _a.include, documentType = _a.documentType, useTaxDateOverride = _a.useTaxDateOverride, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/refund"),
            parameters: {
                $include: include,
                documentType: documentType,
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.settleTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/settle"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.uncommitTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/uncommit"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.unvoidTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/unvoid"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.VarianceResponseModel}
     */
    AvaTaxClient.prototype.varianceReport = function (_a) {
        var companyCode = _a.companyCode, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/variance"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.verifyTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/verify"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     * @return {Models.TransactionModel}
     */
    AvaTaxClient.prototype.voidTransaction = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, include = _a.include, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/void"),
            parameters: {
                documentType: documentType,
                $include: include
            }
     ...
     */
    AvaTaxClient.prototype.createUPCs = function (_a) {
        var companyId = _a.companyId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/upcs"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteUPC = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/upcs/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.UPCModel}
     */
    AvaTaxClient.prototype.getUPC = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/upcs/").concat(id),
            parameters: {}
     ...
     */
    AvaTaxClient.prototype.listUPCsByCompany = function (_a) {
        var companyId = _a.companyId, filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/upcs"),
            parameters: {
     ...
     * @return {FetchResult<Models.UPCModel>}
     */
    AvaTaxClient.prototype.queryUPCs = function (_a) {
        var filter = _a.filter, include = _a.include, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/upcs",
            parameters: {
     ...
     * @return {Models.UPCModel}
     */
    AvaTaxClient.prototype.updateUPC = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/upcs/").concat(id),
            parameters: {}
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteUserDefinedField = function (_a) {
        var companyId = _a.companyId, id = _a.id;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/userdefinedfields/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listUserDefinedFieldsByCompanyId = function (_a) {
        var companyId = _a.companyId, udfType = _a.udfType, allowDefaults = _a.allowDefaults;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/userdefinedfields"),
            parameters: {
                udfType: udfType,
     ...
     */
    AvaTaxClient.prototype.updateUserDefinedField = function (_a) {
        var companyId = _a.companyId, id = _a.id, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyId, "/userdefinedfields"),
            parameters: {
     ...
     * @return {string}
     */
    AvaTaxClient.prototype.changePassword = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.createUsers = function (_a) {
        var accountId = _a.accountId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.ErrorDetail[]}
     */
    AvaTaxClient.prototype.deleteUser = function (_a) {
        var id = _a.id, accountId = _a.accountId;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users/").concat(id),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {Models.UserModel}
     */
    AvaTaxClient.prototype.getUser = function (_a) {
        var id = _a.id, accountId = _a.accountId, include = _a.include;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users/").concat(id),
            parameters: {
                $include: include
     ...
     */
    AvaTaxClient.prototype.getUserEntitlements = function (_a) {
        var id = _a.id, accountId = _a.accountId;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users/").concat(id, "/entitlements"),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     */
    AvaTaxClient.prototype.listUsersByAccount = function (_a) {
        var accountId = _a.accountId, include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users"),
            parameters: {
                $include: include,
     ...
     * @return {FetchResult<Models.UserModel>}
     */
    AvaTaxClient.prototype.queryUsers = function (_a) {
        var include = _a.include, filter = _a.filter, top = _a.top, skip = _a.skip, orderBy = _a.orderBy;
        var path = this.buildUrl({
            url: "/api/v2/users",
            parameters: {
     ...
     * @return {Models.UserModel}
     */
    AvaTaxClient.prototype.updateUser = function (_a) {
        var id = _a.id, accountId = _a.accountId, model = _a.model;
        var path = this.buildUrl({
            url: "/api/v2/accounts/".concat(accountId, "/users/").concat(id),
            parameters: {}
        });
     ...
     * @return {Models.SubscriptionModel}
     */
    AvaTaxClient.prototype.getMySubscription = function (_a) {
        var serviceTypeId = _a.serviceTypeId;
        var path = this.buildUrl({
            url: "/api/v2/utilities/subscriptions/".concat(serviceTypeId),
            parameters: {}
        });
        var strClientId = this.appNM +
            '; ' +
     ...
     * @return {FetchResult<Models.SubscriptionModel>}
     */
    AvaTaxClient.prototype.listMySubscriptions = function () {
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.findAgeVerification = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {}
     */
    AvaTaxClient.prototype.storeAgeVerification = function (_a) {
        var model = _a.model;
        var path = this.buildUrl({
     ...
     */
    AvaTaxClient.prototype.storeIfVerified = function (_a) {
        var simulatedFailureCode = _a.simulatedFailureCode, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {Models.AgeVerifyResult}
     */
    AvaTaxClient.prototype.verifyAge = function (_a) {
        var simulatedFailureCode = _a.simulatedFailureCode, model = _a.model;
        var path = this.buildUrl({
     ...
     * @return {}
     */
    AvaTaxClient.prototype.deregisterShipment = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, _b = _a.api_version, api_version = _b === void 0 ? "" : _b, _c = _a.x_avalara_version, x_avalara_version = _c === void 0 ? "" : _c;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/shipment/registration"),
            parameters: {
                documentType: documentType,
     ...
     * @return {}
     */
    AvaTaxClient.prototype.registerShipment = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, _b = _a.api_version, api_version = _b === void 0 ? "" : _b, _c = _a.x_avalara_version, x_avalara_version = _c === void 0 ? "" : _c;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/shipment/registration"),
            parameters: {
     ...
     */
    AvaTaxClient.prototype.registerShipmentIfCompliant = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, _b = _a.api_version, api_version = _b === void 0 ? "" : _b, _c = _a.x_avalara_version, x_avalara_version = _c === void 0 ? "" : _c;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/shipment/registerIfCompliant"),
            parameters: {
                documentType: documentType,
                'api-version': api_version
            }
     ...
     * @return {Models.ShippingVerifyResult}
     */
    AvaTaxClient.prototype.verifyShipment = function (_a) {
        var companyCode = _a.companyCode, transactionCode = _a.transactionCode, documentType = _a.documentType, _b = _a.api_version, api_version = _b === void 0 ? "" : _b, _c = _a.x_avalara_version, x_avalara_version = _c === void 0 ? "" : _c;
        var path = this.buildUrl({
            url: "/api/v2/companies/".concat(companyCode, "/transactions/").concat(transactionCode, "/shipment/verify"),
            parameters: {
                documentType: documentType,
                'api-version': api_version
            }
